...
const DropDownBar = () => {
    ...
    return(
        ...
        >
            ...
            <ListButton to="/dashboard/overview" title={'Overview'} icon={<BarChartOutlined />}/>
            <ListButton to="/dashboard/teams" title={'Teams'} icon={<UsergroupDeleteOutlined />}/>
            <ListButton to="/dashboard/billing" title={'Billing & Subscription'} icon={<CreditCardOutlined />}/>
